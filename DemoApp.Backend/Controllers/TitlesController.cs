...
namespace DemoApp.Backend.Controllers
{
    public class TitlesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TitleID,JobTitle")] Title title)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TitleID,JobTitle")] Title title)
        {
            if (ModelState.IsValid)
            {
