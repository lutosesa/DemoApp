...
namespace DemoApp.Backend.Controllers
{
    public class SectionsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "SectionID,SectionName")] Section section)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "SectionID,SectionName")] Section section)
        {
            if (ModelState.IsValid)
            {
